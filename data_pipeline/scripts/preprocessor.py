...
def process_users(characters, interpretations, cfg):
    ...
    for char in characters:
        ...
        processed.append({
            ...
            "age": int(float(char.get("Age", 0))) if not pd.isna(char.get("Age", 0)) else 0,
            ...
            "reading_count": int(float(char.get("Reading_Count", 0))) if not pd.isna(char.get("Reading_Count", 0)) else 0,
            "experience_level": char.get("Experience_Level", ""),
            #"experience_count": int(float(char.get("Experience_Count", 0) or 0)),
            "experience_count": int(float(char.get("Experience_Count", 0))) if not pd.isna(char.get("Experience_Count", 0)) else 0,
